...
/*
   ...
   Arduino pin 8 to motor controller pin
*/
...
/*
    Pin usage
*/
const int motorControllerRX = A0; //was 8, but really, not connected
const int motorControllerTX = 8; //was 12; move this to 8 since 12 is only two pins
const int LEDPin = 13;
...
SoftwareSerial softwareSerial(motorControllerRX, motorControllerTX); // RX, TX
